...
export enum enumAccessOnPage {  
  ...
  UserGroupEntityPermission = 'UserGroupEntityPermission',
  
  DataSetup = 'DataSetup',
  
  AssignUsersToUserGroup = 'AssignUsersToUserGroup',
  EntityMaster = 'EntityMaster',
  AssignEntityToUser = 'AssignEntityToUser',
  Home = 'Home',
  ...
  TopRoyalityPerformer = 'TopRoyalityPerformer',
  QualifyingTabTeam = 'QualifyingTabTeam',
  QualifyingAwt = 'QualifyingAwt',
  VpPopulation = 'VpPopulation',
  ProductPenetration = 'ProductPenetration',
  NutritionClubReport = 'NutritionClubReport',
  KoreaBIHomepage = 'KoreaBIHomepage',
